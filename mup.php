...
<body>
	...
	if(isset($_POST['update']))
	{
		...
		$apper=$_POST['apper'];
		$goal=$_POST['goal'];
  $sql = "UPDATE 3718110_manutd.mid SET name='$name', nationality='$nationality', dob='$dob', height='$height', jersy_no='$jersy_no', pos='$pos', bpos='$bpos', apper='$apper', goal='$goal' WHERE jersy_no='$jersy_no'"; 
