		...
		if($name == "")
{
  ...
  echo'<script>location="player.php"</script>';
		...
		$result = "INSERT INTO 3718110_manutd.players (club_id,name, nationality, dob, height, jersy_no, position,bpos) values('$club_id','$name','$nationality','$dob','$height','$jersy_no','$pos','$bpos')";
